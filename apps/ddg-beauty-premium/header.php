  ...
  <div class="container nav">
    <a class="brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="<?php echo esc_attr(get_bloginfo('name')); ?> - Trang chủ">
      ...
      if ($custom_logo_id) {
          ...
          echo '<img class="site-logo" src="' . esc_url(get_template_directory_uri() . '/assets/images/logo-dang-duong.png') . '" alt="' . esc_attr(get_bloginfo('name')) . '" width="420" height="140" loading="eager" fetchpriority="high" decoding="async">';
      }
      ?>
    </a>
          ...
          <ul class="menu primary-menu" id="primary-menu">
            ...
            <li class="menu-item menu-item-has-children ddg-menu-mega"><a href="<?php echo esc_url(home_url('/thuong-hieu/')); ?>">Thương hiệu</a>
              <ul class="sub-menu">
                ...
                <li><a href="<?php echo esc_url(home_url('/x2/')); ?>">X2</a></li>
                <li><a href="<?php echo esc_url(home_url('/havi/')); ?>">HAVI</a></li>
                <li><a href="<?php echo esc_url(home_url('/tgk/')); ?>">TGK</a></li>
