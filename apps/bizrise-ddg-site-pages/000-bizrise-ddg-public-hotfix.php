...
final class Bizrise_DDG_Public_Hotfix_2026 {
    ...
    public static function clean_public_copy(string $html): string {
        $replace = [
            ...
            'Một Product Truth — nhiều creator voice' => 'Một nền tảng thông tin — nhiều cách kể sáng tạo',
